...
fun lightColorScheme(
    ...
    backgroundMicaBase: Color = Color(0x80F3F3F3),
    backgroundAcrylicDefault: Color = Color(0xD9FCFCFC),
    backgroundAcrylicBase: Color = Color(0xE5F3F3F3),
    backgroundAcrylicAccentDefault: Color = Color(0xCC99EBFF),
    backgroundAcrylicAccentBase: Color = Color(0xCC99EBFF),
...
fun darkColorScheme(
    ...
    backgroundMicaBase: Color = Color(0xCC202020),
    backgroundAcrylicDefault: Color = Color(0x262C2C2C),
    backgroundAcrylicBase: Color = Color(0x80202020),
